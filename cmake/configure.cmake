...
if(WITH_XPU)
  ...
  if(CUPTI_FOUND)
    ...
    message(STATUS "Cannot find CUPTI, XPU Profiling is incorrect.")
  endif()
endif()
...
if(WITH_MPS)
  ...
  if(APPLE)
    ...
    if(METAL_FRAMEWORK AND METALPERFORMANCESHADERS_FRAMEWORK AND FOUNDATION_FRAMEWORK)
      message(STATUS "Found Metal frameworks for MPS support")
    else()
      message(FATAL_ERROR "Required Metal frameworks not found for MPS")
    endif()
  endif()
endif()
