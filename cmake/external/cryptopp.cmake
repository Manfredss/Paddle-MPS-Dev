...
set(CRYPTOPP_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
if(APPLE)
  # Apple Clang doesn't support ARM CRC32 intrinsics, so disable them
  set(CRYPTOPP_CXX_FLAGS "${CRYPTOPP_CXX_FLAGS} -DCRYPTOPP_ARM_CRC32_AVAILABLE=0")
endif()
...
set(CRYPTOPP_CMAKE_ARGS
    ...
    -DCMAKE_CXX_FLAGS=${CRYPTOPP_CXX_FLAGS}
