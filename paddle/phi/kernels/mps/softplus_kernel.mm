    ...
    MPSGraphTensor* x_beta =
        [graph multiplicationWithPrimaryTensor:beta_tensor
                               secondaryTensor:x_tensor
                                          name:@"softplus_x_beta"];
    MPSGraphTensor* exp_x_beta = [graph exponentWithTensor:x_beta
                                                      name:@"softplus_exp"];
    MPSGraphTensor* one_plus_exp =
        [graph additionWithPrimaryTensor:one
                         secondaryTensor:exp_x_beta
                                    name:@"softplus_one_plus_exp"];
    MPSGraphTensor* log_term = [graph logarithmWithTensor:one_plus_exp
                                                     name:@"softplus_log"];
    MPSGraphTensor* soft_branch =
        [graph divisionWithPrimaryTensor:log_term
                         secondaryTensor:beta_tensor
                                    name:@"softplus_soft_branch"];
    MPSGraphTensor* pred =
        [graph greaterThanWithPrimaryTensor:x_beta
                            secondaryTensor:threshold_tensor
                                       name:@"softplus_pred"];
    MPSGraphTensor* result_tensor =
        [graph selectWithPredicateTensor:pred
                     truePredicateTensor:x_tensor
                    falsePredicateTensor:soft_branch
