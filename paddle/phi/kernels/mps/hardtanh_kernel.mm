...
void HardTanhKernelImpl(const MPSContext& dev_ctx,
  ...
  @autoreleasepool {
    ...
    MPSGraphTensor* tmin = [graph constantWithScalar:t_min
                                               shape:@[@1]
                                            dataType:MPSDataTypeFloat32];
    MPSGraphTensor* tmax = [graph constantWithScalar:t_max
                                               shape:@[@1]
                                            dataType:MPSDataTypeFloat32];
    MPSGraphTensor* clamped_low = [graph maximumWithPrimaryTensor:x_tensor
                                                 secondaryTensor:tmin
                                                            name:@"hardtanh_max"];
    MPSGraphTensor* result_tensor = [graph minimumWithPrimaryTensor:clamped_low
                                                   secondaryTensor:tmax
